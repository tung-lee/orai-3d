    ...
    <div className="mx-[45px] mb-[40px] inline-flex flex-col items-center justify-center gap-[16px] p-[24px] relative rounded-[24px] border border-solid border-collection-1-line">
      ...
      <div className="flex items-end justify-between self-stretch w-full relative flex-[0_0_auto]">
        <div className="inline-flex flex-col items-start relative flex-[0_0_auto]">
          <div className="relative w-fit mt-[-1.00px] font-header-3 font-[number:var(--header-3-font-weight)] text-white text-[length:var(--header-3-font-size)] tracking-[var(--header-3-letter-spacing)] leading-[var(--header-3-line-height)] [font-style:var(--header-3-font-style)]" style={{ color: "white" }}>
            {name}
          </div>
